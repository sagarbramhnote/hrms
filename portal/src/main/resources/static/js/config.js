...
*/
	...
	$stateProvider
								...
								return $ocLazyLoad
										.load([
												...
												},
												{
													name : 'ngImgCrop',
													files : [
															'js/plugins/ngImgCrop/ng-img-crop.js',
			 ...
			 * "views/login.html", data : { pageTitle : 'Login', specialClass :
			 * 'gray-bg' } })
			 */
...
angular.module('srmt').config(config).run(function($rootScope, $state,$window) {
	$rootScope.$state = $state;
	var windowElement = angular.element($window);
	windowElement.on('onbeforeunload', function(event) {
		// do whatever you want in here before the page unloads.

		console.log("dasdasrund is called");
