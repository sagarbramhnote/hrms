...
@Audited
@Entity
@Table(name = "hrms_state_master")
//@EntityListeners(AuditingEntityListener.class)
public class State implements Serializable, IEntity<State> {

	/**
	 * 
	 */
	private static final long serialVersionUID = -981908857908143422L;
