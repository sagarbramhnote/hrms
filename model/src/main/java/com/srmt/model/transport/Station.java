...
@Audited
@Entity
@Table(name="transport_station_master")
@EntityListeners(AuditingEntityListener.class)
public class Station implements Serializable,IEntity<Station>{
