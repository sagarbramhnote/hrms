...
@Audited
@Entity
@Table(name = "hrms_documentCategory_master")
...
public class DocumentCategory implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2428950652726284790L;
	...
	@OneToMany(cascade = CascadeType.ALL, orphanRemoval = true, mappedBy = "documentCategory")
